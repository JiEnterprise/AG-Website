  ...
  return (
    <main className="bg-obsidian text-pale-gold min-h-screen">
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        ...
        <div className="grid sm:grid-cols-3 gap-8">
          {[
            ...
            <div key={c.title} className="rounded-2xl border border-[rgba(255,255,255,0.09)] bg-[rgba(255,255,255,0.04)] p-8 flex flex-col group hover:border-[rgba(255,255,255,0.18)] hover:-translate-y-1 transition-all duration-200">
              ...
              <p className="font-dm text-[13px] text-[#86868B] leading-relaxed flex-1 mb-6">{c.desc}</p>
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        <div className="flex items-end justify-between mb-12">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <button onClick={() => setActiveSlide(Math.max(0, activeSlide - 1))} className="w-10 h-10 rounded-full border border-[rgba(255,255,255,0.18)] flex items-center justify-center text-aurum-gold hover:bg-aurum-gold hover:text-[#000000] transition-all duration-200 disabled:opacity-30" disabled={activeSlide === 0}>
              <ArrowLeft size={14} />
            </button>
            <button onClick={() => setActiveSlide(Math.min(SOLUTIONS.length - 3, activeSlide + 1))} className="w-10 h-10 rounded-full border border-[rgba(255,255,255,0.18)] flex items-center justify-center text-aurum-gold hover:bg-aurum-gold hover:text-[#000000] transition-all duration-200 disabled:opacity-30" disabled={activeSlide >= SOLUTIONS.length - 3}>
              <ArrowRight size={14} />
            </button>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {SOLUTIONS.slice(activeSlide, activeSlide + 3).map((s, i) => (
            <div key={i} className="group cursor-pointer rounded-2xl border border-[rgba(255,255,255,0.09)] bg-[rgba(255,255,255,0.04)] overflow-hidden hover:border-[rgba(255,255,255,0.18)] hover:-translate-y-1 transition-all duration-200">
              <div className="h-40 bg-gradient-to-br from-[#111111] to-[#1A1810] flex items-center justify-center">
              ...
              <div className="p-6">
                ...
                <p className="font-dm text-[12px] text-[#6E6E73] leading-relaxed">{s.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        ...
        <div className="rounded-2xl border border-[rgba(255,255,255,0.11)] bg-[rgba(255,255,255,0.05)] p-10 sm:p-14 flex flex-col sm:flex-row gap-10 items-center">
          <div className="flex-1">
            <p className="font-dm text-[11px] uppercase tracking-[0.16em] text-[#6E6E73] mb-4">2026 Outlook</p>
            ...
            <p className="font-dm text-[13px] text-[#86868B] leading-relaxed mb-8">Read our latest report on navigating macroeconomic uncertainty, geopolitical shifts, and AI-driven market dynamics — and how we're positioning client portfolios accordingly.</p>
          ...
          <div className="w-full sm:w-64 h-48 rounded-xl bg-gradient-to-br from-[#1C1C1E] to-[#000000] border border-[rgba(255,255,255,0.09)] flex items-center justify-center flex-shrink-0">
            <div className="text-center">
              <p className="font-playfair text-[42px] text-aurum-gold opacity-40">2026</p>
              <p className="font-dm text-[9px] uppercase tracking-[0.2em] text-[#6E6E73] mt-1">AG Outlook</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {OFFERINGS.map(o => (
            <div key={o.category}>
              <p className="font-dm text-[9px] uppercase tracking-[0.22em] text-[#6E6E73] mb-5">{o.category}</p>
              {o.items.map(item => (
                <a key={item} href="#" className="group flex items-center justify-between py-3 border-b border-[rgba(255,255,255,0.06)] last:border-0 hover:border-[rgba(255,255,255,0.13)] transition-colors duration-150">
                  <span className="font-dm text-[13px] text-[#F5F5F7] group-hover:text-pale-gold transition-colors duration-150">{item}</span>
                  <ChevronRight size={13} strokeWidth={1.5} className="text-[#6E6E73] group-hover:text-aurum-gold transition-colors duration-150 flex-shrink-0" />
                </a>
              ))}
            </div>
          ))}
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {[
            ...
            <div key={a.award} className="rounded-2xl border border-[rgba(255,255,255,0.09)] bg-[rgba(255,255,255,0.04)] p-7">
              ...
              <p className="font-dm text-[11px] text-[#6E6E73] leading-relaxed">{a.org}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="insights" className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        <p className="font-dm text-[10px] uppercase tracking-[0.28em] text-aurum-gold mb-4">Wealth Management Insights</p>
        <div className="grid sm:grid-cols-3 gap-6">
          {INSIGHTS.map((ins, i) => (
            <a key={i} href="#" className="group rounded-2xl border border-[rgba(255,255,255,0.09)] bg-[rgba(255,255,255,0.04)] overflow-hidden hover:border-[rgba(255,255,255,0.18)] hover:-translate-y-1 transition-all duration-200">
              <div className="h-36 bg-gradient-to-br from-[#111111] to-[#0D0C06] flex items-end p-5">
                <span className="font-dm text-[9px] uppercase tracking-[0.16em] px-3 py-1 rounded-full border border-[rgba(255,255,255,0.18)] text-aurum-gold">{ins.tag}</span>
              </div>
              <div className="p-6">
                ...
                <p className="font-dm text-[10px] text-[#6E6E73]">{ins.date} · {ins.read}</p>
              </div>
            </a>
          ))}
        </div>
      ...
      <section id="contact" className="max-w-[1240px] mx-auto px-6 sm:px-10 py-28 text-center">
        ...
        <a href="/sign-in" className="inline-flex items-center gap-2 px-8 h-13 bg-aurum-gold font-dm text-[12px] uppercase tracking-[0.12em] text-[#000000] font-medium hover:bg-pale-gold transition-all duration-200">
          Request an Introduction <ArrowRight size={14} strokeWidth={2} />
        </a>
      </section>
