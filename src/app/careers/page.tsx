    ...
    <main className="bg-obsidian text-pale-gold min-h-screen">
      ...
      <section className="relative min-h-[88vh] flex flex-col justify-end overflow-hidden border-b border-[rgba(201,168,76,0.1)]">
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto w-full px-6 sm:px-10 pb-20">
          ...
          <p className="font-dm text-[16px] leading-relaxed text-[#C8BEA8] max-w-[580px] mb-10">
            World-class careers in finance, technology, and strategy — across 47 offices and every corner of global markets.
          </p>
          <Link
            href="/careers/open-roles"
            className="inline-flex items-center gap-2 px-7 h-12 bg-aurum-gold font-dm text-[12px] uppercase tracking-[0.12em] text-[#0A0800] font-medium hover:bg-pale-gold transition-all duration-200"
          >
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {NAV_CARDS.map((card) => (
            <Link
              key={card.href}
              href={card.href}
              className="group rounded-2xl border border-[rgba(201,168,76,0.1)] bg-[rgba(17,17,20,0.6)] p-8 hover:border-[rgba(201,168,76,0.32)] hover:-translate-y-1 transition-all duration-200"
            >
              ...
              <p className="font-dm text-[13px] text-[#8A8070] leading-relaxed mb-6">{card.desc}</p>
        ...
        <div className="max-w-[1240px] mx-auto px-6 sm:px-10 py-16">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link
              ...
              className="hidden sm:inline-flex items-center gap-2 font-dm text-[11px] uppercase tracking-[0.12em] text-aurum-gold border border-[rgba(201,168,76,0.35)] px-5 h-10 hover:bg-aurum-gold hover:text-[#0A0800] transition-all duration-200"
            >
          ...
          <div className="flex flex-wrap gap-3">
            {OFFICES.map((o) => (
              <Link
                key={o.city}
                href="/careers/featured-offices"
                className="group flex items-center gap-3 rounded-full border border-[rgba(201,168,76,0.12)] bg-[rgba(17,17,20,0.5)] px-5 h-11 hover:border-[rgba(201,168,76,0.4)] hover:bg-[rgba(201,168,76,0.06)] transition-all duration-200"
              >
                <span className="font-dm text-[13px] text-pale-gold">{o.city}</span>
                <span className="font-dm text-[10px] text-[#5A5040] uppercase tracking-wider">{o.role}</span>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(201,168,76,0.1)]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {VALUES.map((v, i) => (
            ...
            >
              <p className="font-playfair text-[11px] text-[#5A5040] uppercase tracking-[0.2em] mb-4">0{i + 1}</p>
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24">
        <div className="rounded-2xl border border-[rgba(201,168,76,0.14)] bg-[rgba(17,17,20,0.7)] px-10 py-16 text-center">
          ...
          <p className="font-dm text-[15px] text-[#C8BEA8] max-w-[520px] mx-auto mb-10 leading-relaxed">
            Explore open positions across every division, region, and career level. Your next chapter starts here.
          </p>
          <Link
            href="/careers/open-roles"
            className="inline-flex items-center gap-2 px-8 h-13 bg-aurum-gold font-dm text-[12px] uppercase tracking-[0.14em] text-[#0A0800] font-medium hover:bg-pale-gold transition-all duration-200 py-4"
          >
            View Open Roles <ArrowRight size={14} strokeWidth={2} />
          </Link>
        </div>
