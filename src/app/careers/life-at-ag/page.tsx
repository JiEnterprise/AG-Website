      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {VALUES_IN_ACTION.map((v) => (
            <div
              key={v.title}
              className="rounded-2xl border border-[rgba(255,255,255,0.09)] bg-[rgba(255,255,255,0.04)] p-8"
            >
              <p className="font-playfair text-[11px] text-[#6E6E73] uppercase tracking-[0.2em] mb-4">{v.number}</p>
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {EMPLOYEE_VOICES.map((v) => (
            <div
              key={v.name}
              className="rounded-2xl border border-[rgba(255,255,255,0.09)] bg-[rgba(255,255,255,0.04)] p-8 flex flex-col"
            >
              <p className="font-playfair text-[17px] italic text-pale-gold leading-[1.5] flex-1 mb-8">
                &ldquo;{v.quote}&rdquo;
              </p>
              <div className="flex items-center gap-3 pt-6 border-t border-[rgba(255,255,255,0.07)]">
                ...
                <div>
                  ...
                  <p className="font-dm text-[11px] text-[#6E6E73] mt-0.5">{v.title} · {v.dept}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {PERKS.map((p) => (
            ...
            >
              ...
              <p className="font-dm text-[13px] text-[#86868B] leading-relaxed">{p.desc}</p>
            </div>
          ))}
        </div>
      </section>
