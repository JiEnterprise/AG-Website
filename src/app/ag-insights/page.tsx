...
const TAG_COLORS: Record<string, string> = {
  'Market Outlook': 'text-aurum-gold border-[rgba(255,255,255,0.18)]',
  ...
  'Macro Strategy': 'text-[#F5F5F7] border-[rgba(200,184,168,0.3)]',
    ...
    <main className="bg-obsidian text-pale-gold min-h-screen">
      ...
      <section className="relative min-h-[60vh] flex flex-col justify-end overflow-hidden border-b border-[rgba(255,255,255,0.09)]">
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto w-full px-6 sm:px-10 pb-20">
          ...
          <p className="font-dm text-[16px] leading-relaxed text-[#F5F5F7] max-w-[560px]">
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        ...
        <a href="#" className="group rounded-2xl border border-[rgba(255,255,255,0.11)] bg-[rgba(255,255,255,0.05)] p-10 sm:p-14 flex flex-col sm:flex-row gap-10 items-center hover:border-[rgba(255,255,255,0.18)] transition-all duration-200 block">
          <div className="flex-1">
            ...
            <p className="font-dm text-[13px] text-[#86868B] leading-relaxed mb-6">{FEATURED.desc}</p>
            <div className="flex items-center gap-4">
              <p className="font-dm text-[11px] text-[#6E6E73]">{FEATURED.date} · {FEATURED.read}</p>
          ...
          {ARTICLES.map((a, i) => (
            <a key={i} href="#" className="group rounded-2xl border border-[rgba(255,255,255,0.09)] bg-[rgba(255,255,255,0.04)] overflow-hidden hover:border-[rgba(255,255,255,0.18)] hover:-translate-y-1 transition-all duration-200">
              ...
              <div className="p-6">
                ...
                <p className="font-dm text-[10px] text-[#6E6E73]">{a.date} · {a.read}</p>
              </div>
            </a>
          ))}
        </div>
