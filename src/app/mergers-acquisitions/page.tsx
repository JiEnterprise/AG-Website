    ...
    <main className="bg-obsidian text-pale-gold min-h-screen">
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(201,168,76,0.1)]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {OFFERINGS.map(o => (
            <div key={o.title} className="rounded-2xl border border-[rgba(201,168,76,0.1)] bg-[rgba(17,17,20,0.6)] p-7 hover:border-[rgba(201,168,76,0.28)] hover:-translate-y-1 transition-all duration-200">
              <h3 className="font-playfair text-[18px] text-pale-gold mb-3">{o.title}</h3>
              <p className="font-dm text-[12px] text-[#8A8070] leading-relaxed">{o.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(201,168,76,0.1)]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {SECTORS.map(s => (
            <div key={s} className="flex items-center gap-4 py-5 border-b border-[rgba(201,168,76,0.07)]">
              <div className="w-1.5 h-1.5 rounded-full bg-aurum-gold opacity-60 flex-shrink-0" />
              <span className="font-dm text-[14px] text-[#C8BEA8]">{s}</span>
            </div>
          ))}
        </div>
      </section>
