    ...
    <main className="bg-obsidian text-pale-gold min-h-screen">
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        ...
        <div className="rounded-2xl border border-[rgba(255,255,255,0.11)] bg-[rgba(255,255,255,0.05)] p-10 sm:p-14 flex flex-col sm:flex-row gap-10 items-center">
          <div className="flex-1">
            <p className="font-dm text-[11px] uppercase tracking-[0.16em] text-[#6E6E73] mb-4">The AGQuant Edge</p>
          ...
          <div className="w-full sm:w-64 h-48 rounded-xl bg-gradient-to-br from-[#1C1C1E] to-[#000000] border border-[rgba(255,255,255,0.09)] flex items-center justify-center flex-shrink-0">
            <div className="text-center">
              ...
              <p className="font-dm text-[9px] uppercase tracking-[0.2em] text-[#6E6E73] mt-1">AGQuant Engine</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1240px] mx-auto px-6 sm:px-10 py-24 border-b border-[rgba(255,255,255,0.09)]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {FEATURES.map(f => (
            <div key={f.title} className="rounded-2xl border border-[rgba(255,255,255,0.09)] bg-[rgba(255,255,255,0.04)] p-7 hover:border-[rgba(255,255,255,0.18)] hover:-translate-y-1 transition-all duration-200">
              <h3 className="font-playfair text-[18px] text-pale-gold mb-3">{f.title}</h3>
              <p className="font-dm text-[12px] text-[#86868B] leading-relaxed">{f.desc}</p>
            </div>
          ))}
        </div>
      </section>
